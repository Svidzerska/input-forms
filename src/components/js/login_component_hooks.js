   ...
   return (
      <div className="form_login">
         <form onSubmit={handleSubmit}>
            ...
            <InputHooks type="text" className="login_input" onChange={handleChanges} name="login" />
            <br />
            <span className="name_of_input">Your password</span><br />
            <InputHooks type="password" className="login_input" onChange={handleChanges} name="password" />
            <br />
