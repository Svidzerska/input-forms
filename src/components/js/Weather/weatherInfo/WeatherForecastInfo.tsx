...
function WeatherForecastInfo(props : any) {
   ...
   return (<div>
      <div className={city !== "" ? "weatherForecast__information" : "weatherForecast__information_hidden"}>
         <div className="weatherForecast__information_city"><p>Chosen city: <p className="weatherForecast__information_cityName">{city}</p></p></div>
   </div>
   </div>
   )
};
